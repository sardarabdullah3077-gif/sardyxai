        ...
        <div className="fixed inset-0 z-50 bg-black/90 backdrop-blur-sm flex flex-col">
          ...
          <div className="flex items-center justify-between px-6 py-4 bg-[#111] border-b border-white/10">
            <div className="flex items-center gap-3">
              ...
              {!isPreviewable && (
                <span className="text-sm font-mono text-zinc-500 uppercase tracking-widest ml-2 flex items-center gap-1.5">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-sm font-mono text-zinc-400 hover:text-white transition-colors p-2 hover:bg-white/5 rounded-lg"
