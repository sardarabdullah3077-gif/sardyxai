...
// ── Inline system prompt for Vercel serverless compatibility ──────────────────
const SARDYX_SYSTEM_PROMPT = `You are SARDYX AI, a premium autonomous AI agent created by Sardar Abdullah Fazal.
